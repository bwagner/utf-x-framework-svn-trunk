 ...
 * 
 * <code>
 * $Source: /cvs/utf-x/framework/src/java/utfx/testgen/test/PackageTestSuite.java,v $
 * </code>
 * 
 * @author Jacek Radajewski
 * @version $Revision: 1.2 $ $Date: 2006/04/01 20:44:13 $ $Name:  $
 */
public class PackageTestSuite extends TestCase {
    ...
    public static Test suite() {
        TestSuite suite = new TestSuite("utfx.testgen");

        suite.addTest(TestGeneratorTest.suite());
        suite.addTest(SourceExpectedBuilderTest.suite());        
