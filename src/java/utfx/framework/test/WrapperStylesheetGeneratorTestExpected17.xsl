...
<!--
  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  $Id: WrapperStylesheetGeneratorTestExpected17.xsl,v 1.1.2.1 2006/08/22 14:57:02 lachdrache Exp $
  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="/">
    <utfx-wrapper>
      ...
      <xsl:apply-templates select="exsl:node-set($utfx-wrapper-removed)"/>
    </utfx-wrapper>
  </xsl:template>
</xsl:stylesheet>
