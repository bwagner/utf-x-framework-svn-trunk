...
/**
 * au.edu.usq.utfx.framework package test suite.
 * 
 * <p>
 ...
 * 
 * <code>
 * $Source: /cvs/utf-x/framework/src/java/utfx/framework/test/PackageTestSuite.java,v $
 * </code>
 * 
 * @author Jacek Radajewski
 * @version $Revision: 1.3.2.1 $ $Date: 2006/08/02 14:20:15 $ $Name:  $
 */
public class PackageTestSuite extends TestCase {
    ...
    public static Test suite() {
        ...
        suite.addTest(SourceParserFactoryTest.suite());
        suite.addTest(UTFXTestCaseTest.suite());
