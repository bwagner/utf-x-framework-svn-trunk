...
<!--
  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  $Id: WrapperStylesheetGeneratorTestExpected9.xsl,v 1.1.2.1 2006/08/22 14:57:03 lachdrache Exp $
  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
<xsl:stylesheet version="1.0" xmlns:utfx="http://utfx.org/test-definition"
  ...
  <xsl:param name="stylesheet-param2">
    <els>
      <el>fun</el>
      <el>is</el>
    </els>
  ...
  <xsl:template match="/">
    <utfx-wrapper>
      ...
      <xsl:for-each select="exsl:node-set($utfx-wrapper-removed)/*[1]">
        <xsl:call-template name="named-template-and-stylesheet-with-param">
          <xsl:with-param name="a" select="2"/>
          <xsl:with-param name="b" select="1"/>
          <xsl:with-param name="c">
            <i>isn't</i> it </xsl:with-param>
        </xsl:call-template>
      </xsl:for-each>
