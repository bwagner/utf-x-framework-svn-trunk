...
<!--
  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  $Id: WrapperStylesheetGeneratorTestExpected11.xsl,v 1.1.2.1 2006/08/22 14:57:00 lachdrache Exp $
  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
<xsl:stylesheet version="1.0" xmlns:utfx="http://utfx.org/test-definition"
  ...
  <xsl:template match="/">
    <utfx-wrapper>
      ...
      <xsl:for-each select="exsl:node-set($utfx-wrapper-removed)/root/depth-one">
