...
<!--
  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  $Id: WrapperStylesheetGeneratorTestExpected8.xsl,v 1.1.2.1 2006/08/22 14:57:08 lachdrache Exp $
  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
<xsl:stylesheet version="1.0" xmlns:utfx="http://utfx.org/test-definition"
  ...
  <xsl:param name="stylesheet-param1">
    <els>
      <el>UTF-X</el>
      <el>is</el>
      <el>great</el>
  ...
  <xsl:param name="stylesheet-param2" select="3"/>
